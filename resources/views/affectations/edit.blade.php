        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h1 class="text-2xl font-bold text-[#0A1C3E]">Modifier l'affectation</h1>
                </div>

                <form action="{{ route('affectation.update', $affectation) }}" method="post" class="p-6 space-y-6">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <label class="block">
                                ...
                                <input type="text" id="fonction"
                                    class="mt-1 block w-full px-4 py-2.5 text-gray-700 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0A1C3E] focus:border-transparent transition duration-200"
                                    name="fonction" value="{{ old('fonction', $utilisateur->fonction) }}" required>
                                @error('fonction')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </label>
                            <label class="block">
                                ...
                                <input type="text" id="departement"
                                    class="mt-1 block w-full px-4 py-2.5 text-gray-700 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0A1C3E] focus:border-transparent transition duration-200"
                                    name="departement" value="{{ old('departement', $utilisateur->departement) }}" required>
                                @error('departement')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <label class="block">
                                ...
                                <input type="text" id="chantier"
                                    class="mt-1 block w-full px-4 py-2.5 text-gray-700 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0A1C3E] focus:border-transparent transition duration-200"
                                    name="chantier" value="{{ old('chantier', $affectation->chantier) }}">
                                @error('chantier')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </label>
                            <label class="block">
                                ...
                                <input type="text" id="utilisateur"
                                    class="mt-1 block w-full px-4 py-2.5 text-gray-700 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0A1C3E] focus:border-transparent transition duration-200"
                                    name="utilisateur" value="{{ old('utilisateur', $affectation->utilisateur) }}">
                                @error('utilisateur')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <label class="block">
                                ...
                                <input type="text" id="num_serie"
                                    class="mt-1 block w-full px-4 py-2.5 text-gray-700 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0A1C3E] focus:border-transparent transition duration-200"
                                    name="num_serie" value="{{ old('num_serie', $materiel->num_serie) }}" required>
                                @error('num_serie')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </label>
                            <label class="block">
                                ...
                                <select name="statut" id="statut"
                                    class="mt-1 block w-full px-4 py-2.5 text-gray-700 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0A1C3E] focus:border-transparent transition duration-200">
                                    <option {{ $affectation->statut === 'AFFECTE' ? 'selected' : '' }} value="AFFECTE">
                                        AFFECTE</option>
                                    <option {{ $affectation->statut === 'REAFFECTE' ? 'selected' : '' }} value="REAFFECTE">
                                        REAFFECTE</option>
                                    <option {{ $affectation->statut === 'NON AFFECTE' ? 'selected' : '' }}
                                        value="NON AFFECTE">NON AFFECTE</option>
                                </select>
                                @error('statut')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <label class="block">
                                ...
                                <input type="text" id="fabricant"
                                    ...
                                    name="fabricant" value="{{ old('fabricant', $materiel->fabricant) }}" readonly>
                                @error('fabricant')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </label>
                            <label class="block">
                                ...
                                <input type="text" id="type"
                                    class="mt-1 block w-full px-4 py-2.5 text-gray-700 bg-gray-100 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0A1C3E] focus:border-transparent transition duration-200"
                                    name="type" value="{{ old('type', $materiel->type) }}" readonly>
                                @error('type')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </label>
                            <label class="block">
                                ...
                                <input type="text" id="etat"
                                    class="mt-1 block w-full px-4 py-2.5 text-gray-700 bg-gray-100 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0A1C3E] focus:border-transparent transition duration-200"
                                    name="etat" value="{{ old('etat', $materiel->etat) }}" readonly>
                                @error('etat')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </label>
                    ...
                    <div id="ordinateur" class="bg-gray-50 rounded-lg p-4 space-y-6"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <label class="block">
                                ...
                                <input type="text" name="processeur"
                                    class="mt-1 block w-full px-4 py-2.5 text-gray-700 bg-gray-100 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0A1C3E] focus:border-transparent transition duration-200"
                                    id="processeur"
                                    value="{{ old('processeur', $ordinateur ? $ordinateur->processeur : '') }}" readonly
                                    required>
                                @error('processeur')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <label class="block">
                                ...
                                <input type="text" name="ram"
                                    class="mt-1 block w-full px-4 py-2.5 text-gray-700 bg-gray-100 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0A1C3E] focus:border-transparent transition duration-200"
                                    id="ram" value="{{ old('ram', $ordinateur ? $ordinateur->ram : '') }}" readonly
                                    required>
                                @error('ram')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <label class="block">
                                ...
                                <input type="text" name="stockage"
                                    class="mt-1 block w-full px-4 py-2.5 text-gray-700 bg-gray-100 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0A1C3E] focus:border-transparent transition duration-200"
                                    id="stockage"
                                    value="{{ old('stockage', $ordinateur ? $ordinateur->stockage : '') }}" readonly
                                    required>
                                @error('stockage')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
