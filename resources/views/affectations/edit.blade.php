        ...
        <div class="max-w-3xl mx-auto">
            <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                <div class="bg-[#0A1C3E] px-6 py-4">
                    <h1 class="text-xl font-semibold text-white">Modifier l'affectation</h1>
                </div>

                <form action="{{ route('affectation.update', $affectation) }}" method="post" class="p-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="space-y-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <select name="statut" id="statut"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-[#0A1C3E] focus:border-[#0A1C3E] @error('statut') outline-2 outline-red-500 @enderror">
                                        <option {{ $affectation->statut === 'AFFECTE' ? 'selected' : '' }} value="AFFECTE">
                                            AFFECTE</option>
                                        <option {{ $affectation->statut === 'REAFFECTE' ? 'selected' : '' }}
                                            value="REAFFECTE">REAFFECTE</option>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="etat" name="etat"
                                        value="{{ old('etat', $materiel->etat) }}" readonly
                                        class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm bg-gray-50">
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="ordinateur" class="space-y-4"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <input type="text" id="processeur" name="processeur"
                                        value="{{ old('processeur', $ordinateur ? $ordinateur->processeur : '') }}"
                                        readonly required
                                        class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm bg-gray-50">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="ram" name="ram"
                                        value="{{ old('ram', $ordinateur ? $ordinateur->ram : '') }}" readonly required
                                        class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm bg-gray-50">
                                </div>
