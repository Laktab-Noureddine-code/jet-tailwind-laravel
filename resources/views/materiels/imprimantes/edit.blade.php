        ...
        <div class="max-w-3xl mx-auto">
            <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                <div class="bg-[#0A1C3E] px-6 py-4">
                    <h1 class="text-xl font-semibold text-white">Modifier l'imprimante</h1>
                </div>

                <form action="{{ route('imprimantes.update', $imprimante->id) }}" method="POST" class="p-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="space-y-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="num_commande"
                                        value="{{ old('num_commande', $imprimante->num_commande) }}" required
                                        class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-[#0A1C3E] focus:border-[#0A1C3E] @error('num_commande') outline-2 outline-red-500 @enderror">
                                    @error('num_commande')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <select name="etat" required
                                    ...
                                    <option value="Neuf" {{ old('etat', $imprimante->etat) == 'Neuf' ? 'selected' : '' }}>
                                        Neuf</option>
                                    <option value="Occasion"
                                        {{ old('etat', $imprimante->etat) == 'Occasion' ? 'selected' : '' }}>Occasion
                                    </option>
                                    <option value="Endommagé"
                                        {{ old('etat', $imprimante->etat) == 'Endommagé' ? 'selected' : '' }}>Endommagé
                                    </option>
                                </select>
                                @error('etat')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="ip_adresse"
                                    value="{{ old('ip_adresse', $imprimante->ip_adresse) }}"
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="grid grid-cols-5 items-center gap-3">
                                    ...
                                    <div>
                                        <input type="text" name="identifiant_noir"
                                            value="{{ old('identifiant_noir', $imprimante->identifiant_noir) }}"
                                    ...
                                    <div>
                                        <input type="text" name="identifiant_bleu"
                                            value="{{ old('identifiant_bleu', $imprimante->identifiant_bleu) }}"
                                            class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-[#0A1C3E] focus:border-[#0A1C3E]">
                                    </div>
                                    <div>
                                        <input type="text" name="identifiant_magenta"
                                            value="{{ old('identifiant_magenta', $imprimante->identifiant_magenta) }}"
                                            class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-[#0A1C3E] focus:border-[#0A1C3E]">
                                    </div>
                                    <div>
                                        <input type="text" name="identifiant_jaune"
                                            value="{{ old('identifiant_jaune', $imprimante->identifiant_jaune) }}"
                                            class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-[#0A1C3E] focus:border-[#0A1C3E]">
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-5 items-center gap-3">
                                    ...
                                    <div>
                                        <input type="number" min="0" name="toner_noir"
                                            value="{{ old('toner_noir', $imprimante->toner_noir) }}"
                                            class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-[#0A1C3E] focus:border-[#0A1C3E]">
                                    </div>
                                    <div>
                                        <input type="number" min="0" name="toner_bleu"
                                            value="{{ old('toner_bleu', $imprimante->toner_bleu) }}"
                                            class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-[#0A1C3E] focus:border-[#0A1C3E]">
                                    </div>
                                    <div>
                                        <input type="number" min="0" name="toner_magenta"
                                            value="{{ old('toner_magenta', $imprimante->toner_magenta) }}"
                                            class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-[#0A1C3E] focus:border-[#0A1C3E]">
                                    </div>
                                    <div>
                                        <input type="number" min="0" name="toner_jaune"
                                            value="{{ old('toner_jaune', $imprimante->toner_jaune) }}"
                                            class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-[#0A1C3E] focus:border-[#0A1C3E]">
                                    </div>
                                </div>
                            </div>
