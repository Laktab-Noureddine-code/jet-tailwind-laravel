@props(['imprimante'])
<tr class="border-b bg-white hover:bg-gray-50" data-statut="{{ $imprimante->statut }}">
    <td class="px-6 py-4 font-medium text-gray-900">{{ $imprimante->num_serie }}</td>
    <td class="px-6 py-4">{{ $imprimante->fabricant }}</td>
